...
>({children, meta}: MarkdownProps<T>) {
  ...
  return (
    <article className="relative w-screen h-full min-w-0 mx-auto">
      <div className="pt-20 pl-0 lg:pt-0 lg:pl-80 2xl:px-80 ">
        <Seo title={title} />
        {!isHomePage && <PageHeading title={title} description={description} />}
